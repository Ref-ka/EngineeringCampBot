...
def send_welcome(message):
    bot.reply_to(message, "Привет! Я бот, который может сообщить текущее время, выдать случайное "
                          "число и рассказать шутку про программистов. Используй команды /time, /random и /joke.")
